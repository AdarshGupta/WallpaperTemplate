package com.example.adarshgupta.wallpapertemplate.views;
...
import com.example.adarshgupta.wallpapertemplate.R;
import com.example.adarshgupta.wallpapertemplate.fragments.WallpapersFragment;
import com.example.adarshgupta.wallpapertemplate.utilities.PaletteTransformation;
import com.squareup.picasso.Picasso;

import java.util.ArrayList;
import java.util.HashMap;

import static com.example.adarshgupta.wallpapertemplate.utilities.PaletteTransformation.PaletteCallback;
...
public class WallsGridAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
      ...
      //  final String authorwall = jsondata.get(WallpapersFragment.AUTHOR);
