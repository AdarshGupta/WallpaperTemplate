...
import com.example.adarshgupta.wallpapertemplate.HomeActivity;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ((HomeActivity) getActivity()).result.setSelectionByIdentifier(4);
                ((HomeActivity) getActivity()).switchFragment(4, getResources().getString(R.string.section_four), "Apply");
            }
        });
