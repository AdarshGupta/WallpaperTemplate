...
import com.example.adarshgupta.wallpapertemplate.utilities.Preferences;
import com.example.adarshgupta.wallpapertemplate.views.ChangelogAdapter;
...
//        mRequestManager.loadAppsIfEmptyAsync();
        ...
        mPrefs = new Preferences(HomeActivity.this);
      ...
      //  thaRequest = getResources().getString(R.string.section_five);
        ...
        AccountHeader headerResult = new AccountHeaderBuilder()
                ...
                .withSelectionSecondLine("v" + com.example.adarshgupta.wallpapertemplate.utilities.Util.getAppVersion(this))
        ...
        result = new DrawerBuilder()
                ...
                .addDrawerItems(
                        ...
                        new PrimaryDrawerItem().withName(thaWalls).withIcon(GoogleMaterial.Icon.gmd_palette).withIdentifier(4),
...
//                                    break;
                                case 4:
                                    if (com.example.adarshgupta.wallpapertemplate.utilities.Util.hasNetwork(HomeActivity.this)) {
...
//                                    break;
    ...
    public void switchFragment(int itemId, String title, String fragment) {
        ...
        getSupportFragmentManager().beginTransaction()
                ...
                .replace(R.id.main, Fragment.instantiate(HomeActivity.this,
                        "com.example.adarshgupta.wallpapertemplate.fragments." + fragment + "Fragment"))
                .commit();
...
//    }
    ...
    private void showChangelogDialog() {
        ...
        if (launchinfo != null && !launchinfo.equals(com.example.adarshgupta.wallpapertemplate.utilities.Util.getAppVersion(this)))
            showChangelog();
        storeSharedPrefs();
    }
    ...
    private void storeSharedPrefs() {
        ...
        sharedPreferences.edit().putString("version", com.example.adarshgupta.wallpapertemplate.utilities.Util.getAppVersion(this)).commit();
    }
