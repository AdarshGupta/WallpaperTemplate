...
public class DetailedWallpaperActivity extends AppCompatActivity implements View.OnClickListener {

    public String wall,authorwall;
    private String saveWallLocation, picName, dialogContent;
    private static final String TAG_SAVE = "save";
    //tag associated with the FAB menu button that saves
    private static final String TAG_APPLY = "apply";
    //tag associated with the FAB menu button that applies
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView text=(TextView) findViewById(R.id.author);
        authorwall = getIntent().getStringExtra("author");
        text.setText(authorwall);
        Picasso.with(this)
                .load(wall)
...
//FAB
        ...
        sort1.setImageResource(R.drawable.ic_save);



        ImageView sort2=new ImageView(this);
        sort2.setImageResource(R.drawable.ic_check);
        ...
        button1.setTag(TAG_SAVE);
        button2.setTag(TAG_APPLY);
...
//     //here i have specified the listener. now check down for on click method to detect which button was clicked
    ...
    public void onClick(View v) {
        ...
        else if (v.getTag().equals(TAG_APPLY)) {
             showSetWallDialog();
